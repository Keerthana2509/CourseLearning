    ...
    render() {
        ...
        return(
            <div>
                ...
                <h2>Overview</h2>
                <p>
                LearningStudio serves as a platform that allows instructors to build online courses on topics of their choosing. Using LearningStudio's course development tools they can upload video, PowerPoint presentations, PDFs, audio, zip files and live classes to create courses.[citation needed] Instructors can also engage and interact with users via online discussion boards.

Courses are offered across a breadth of categories, including business and entrepreneurship, academics, the arts, health and fitness, language, music, and technology.[citation needed] Most classes are in practical subjects such as Excel software or using an iPhone camera.[16] LearningStudio also offers LearningStudio for Business, enabling businesses access to a targeted suite of over 3,000 training courses on topics from digital marketing tactics to office productivity, design, management, programming, and more. With LearningStudio for Business, organizations can also create custom learning portals for corporate training.[17]

LearningStudio offers paid and free courses, depending on the instructor.[18] In 2015, the top 10 instructors made more than $17 million in total revenue.[4]

In April 2013, LearningStudio offered an app for Apple iOS, allowing students to take classes directly from iPhones;[19] The Android version was launched in January 2014.[20] As of January 2014, the iOS app had been downloaded over 1 million times, and 20 percent of LearningStudio users access their courses via mobile.[21] In July 2016, LearningStudio expanded their iOS platform to include Apple TV.
                </p>
